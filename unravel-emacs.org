...
- [[#the-unravel-langsel-module][The =unravel-langs.el= module]]
  ...
  - [[#the-unravel-langsel-section-for-aider-aiderel][The =unravel-langs.el= section for aider (~aider.el~)]]
  - [[#the-unravel-langsel-section-for-claude-code-claude-code-ideel][The =unravel-langs.el= section for Claude Code (~claude-code-ide.el~)]]
  ...
  - [[#the-unravel-langsel-section-for-yaml][The =unravel-langs.el= section for YAML]]
...
- =uv add ruff pyright --group dev=
  ...
  + Pyright (provides the binary ~pyright~) is the Python Language Server created by Microsoft.
...
** The =unravel-langs.el= section for YAML
:PROPERTIES:
